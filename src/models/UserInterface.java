...
implements ActionListener    // interface which listens for key presses by user
{
	...
	private void makeFrame()
	{
		...
		contentPane.setPreferredSize(new Dimension(900, 480));    //set sizes
	...
	public void actionPerformed(ActionEvent event) 
	{
		...
		if(command.equals("Clear All Text Fields"))
		{
			...
			Pair match=(Pair) dictionary.findMatch(dictionary.getSpanishWord());   //get match 
			if(match==null){
